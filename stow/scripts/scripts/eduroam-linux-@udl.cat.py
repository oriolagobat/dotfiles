...
Messages.user_cert_missing = "No se ha encontrado un certificado " \
    "personal"
Config.instname = "Universitat de Lleida (UdL)"
Config.profilename = "Universitat de Lleida (UdL)"
Config.url = "http://www.udl.cat/ca/wifi"
Config.email = "wifi@llistes.udl.cat"
Config.title = "eduroam CAT"
Config.server_match = "radius.udl.cat"
...
Config.user_realm = "udl.cat"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.udl.cat']
